import{n as e}from"./index-DyFjlgih.js";import{t}from"./shaderStore-D-XQlhUT.js";import"./clipPlaneFragmentDeclaration-BN6UGp5R.js";import"./clipPlaneFragment-BOyMYWEM.js";import"./oitFragment-DefwLXt4.js";import"./helperFunctions-B9t6mxFo.js";import"./mainUVVaryingDeclaration-DYXWxNAK.js";import"./defaultUboDeclaration-DWI5zY2S.js";var n=e({lightsFragmentFunctions:()=>a}),r=`lightsFragmentFunctions`,i=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;t.IncludesShadersStore[r]||(t.IncludesShadersStore[r]=i);var a={name:r,shader:i},o=`defaultFragmentDeclaration`,s=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;t.IncludesShadersStore[o]||(t.IncludesShadersStore[o]=s);var c=`fresnelFunction`,l=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;t.IncludesShadersStore[c]||(t.IncludesShadersStore[c]=l);var u=e({defaultPixelShader:()=>p}),d=`defaultPixelShader`,f=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;t.ShadersStore[d]||(t.ShadersStore[d]=f);var p={name:d,shader:f};export{n as i,u as n,a as r,p as t};