import{n as e}from"./index-dI-RRYjs.js";import{t}from"./shaderStore-D-XQlhUT.js";import"./kernelBlurVaryingDeclaration-Bcpph3LR.js";var n=`kernelBlurVertex`,r=`vertexOutputs.sampleCoord{X}=vertexOutputs.sampleCenter+uniforms.delta*KERNEL_OFFSET{X};`;t.IncludesShadersStoreWGSL[n]||(t.IncludesShadersStoreWGSL[n]=r);var i=e({kernelBlurVertexShaderWGSL:()=>s}),a=`kernelBlurVertexShader`,o=`attribute position: vec2f;uniform delta: vec2f;varying sampleCenter: vec2f;
