import{n as e}from"./index-Ce09xWCQ.js";import{t}from"./shaderStore-D-XQlhUT.js";import"./kernelBlurVaryingDeclaration-DSCV0eGX.js";var n=`kernelBlurVertex`,r=`sampleCoord{X}=sampleCenter+delta*KERNEL_OFFSET{X};`;t.IncludesShadersStore[n]||(t.IncludesShadersStore[n]=r);var i=e({kernelBlurVertexShader:()=>s}),a=`kernelBlurVertexShader`,o=`attribute vec2 position;uniform vec2 delta;varying vec2 sampleCenter;
