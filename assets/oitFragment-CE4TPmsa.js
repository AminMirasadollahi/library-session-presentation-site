import{n as e}from"./index-xuOPDWyC.js";import{t}from"./shaderStore-D-XQlhUT.js";var n=e({bumpFragment:()=>a}),r=`bumpFragment`,i=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;t.IncludesShadersStore[r]||(t.IncludesShadersStore[r]=i);var a={name:r,shader:i},o=`samplerFragmentDeclaration`,s=`#ifdef _DEFINENAME_
...
#endif
`;t.IncludesShadersStore[o]||(t.IncludesShadersStore[o]=s);var c=e({bumpFragmentFunctions:()=>d}),l=`bumpFragmentFunctions`,u=`#if defined(BUMP)
...
#endif
`;t.IncludesShadersStore[l]||(t.IncludesShadersStore[l]=u);var d={name:l,shader:u},ee=e({bumpFragmentMainFunctions:()=>m}),f=`bumpFragmentMainFunctions`,p=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#ifdef OBJECTSPACE_NORMALMAP
...
#endif
`;t.IncludesShadersStore[f]||(t.IncludesShadersStore[f]=p);var m={name:f,shader:p},h=e({fogFragmentDeclaration:()=>v}),g=`fogFragmentDeclaration`,_=`#ifdef FOG
...
#endif
`;t.IncludesShadersStore[g]||(t.IncludesShadersStore[g]=_);var v={name:g,shader:_},te=e({imageProcessingDeclaration:()=>x}),y=`imageProcessingDeclaration`,b=`#ifdef EXPOSURE
...
#endif
`;t.IncludesShadersStore[y]||(t.IncludesShadersStore[y]=b);var x={name:y,shader:b},ne=e({imageProcessingFunctions:()=>w}),S=`imageProcessingFunctions`,C=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;t.IncludesShadersStore[S]||(t.IncludesShadersStore[S]=C);var w={name:S,shader:C},T=e({lightFragment:()=>O}),E=`lightFragment`,D=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStore[E]||(t.IncludesShadersStore[E]=D);var O={name:E,shader:D},re=e({lightFragmentDeclaration:()=>j}),k=`lightFragmentDeclaration`,A=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStore[k]||(t.IncludesShadersStore[k]=A);var j={name:k,shader:A},M=e({lightUboDeclaration:()=>F}),N=`lightUboDeclaration`,P=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;t.IncludesShadersStore[I]||(t.IncludesShadersStore[I]=ie);var L=`clusteredLightingFunctions`,ae=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};ClusteredLight getClusteredLight(sampler2D lightDataTexture,int index) {return ClusteredLight(
...
`;t.IncludesShadersStore[L]||(t.IncludesShadersStore[L]=ae);var oe=e({reflectionFunction:()=>B}),R=`reflectionFunction`,z=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;t.IncludesShadersStore[R]||(t.IncludesShadersStore[R]=z);var B={name:R,shader:z},V=e({shadowsFragmentFunctions:()=>W}),H=`shadowsFragmentFunctions`,U=`#ifdef SHADOWS
...
#endif
#endif
`;t.IncludesShadersStore[H]||(t.IncludesShadersStore[H]=U);var W={name:H,shader:U},G=`logDepthFragment`,K=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;t.IncludesShadersStore[G]||(t.IncludesShadersStore[G]=K);var q=`fogFragment`,se=`#ifdef FOG
...
#endif
`;t.IncludesShadersStore[q]||(t.IncludesShadersStore[q]=se);var J=`decalFragmentDeclaration`,ce=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;t.IncludesShadersStore[J]||(t.IncludesShadersStore[J]=ce);var Y=`prePassDeclaration`,le=`#ifdef PREPASS
...
#endif
#endif
`;t.IncludesShadersStore[Y]||(t.IncludesShadersStore[Y]=le);var X=`oitDeclaration`,ue=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;t.IncludesShadersStore[X]||(t.IncludesShadersStore[X]=ue);var Z=`decalFragment`,de=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;t.IncludesShadersStore[Z]||(t.IncludesShadersStore[Z]=de);var Q=`depthPrePass`,fe=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;t.IncludesShadersStore[Q]||(t.IncludesShadersStore[Q]=fe);var $=`oitFragment`,pe=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;t.IncludesShadersStore[$]||(t.IncludesShadersStore[$]=pe);export{n as S,m as _,F as a,c as b,re as c,w as d,ne as f,h as g,v as h,oe as i,O as l,te as m,V as n,M as o,x as p,B as r,j as s,W as t,T as u,ee as v,a as x,d as y};