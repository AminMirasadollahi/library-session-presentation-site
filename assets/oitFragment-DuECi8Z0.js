import{n as e}from"./index-dI-RRYjs.js";import{t}from"./shaderStore-D-XQlhUT.js";var n=e({bumpFragmentWGSL:()=>a}),r=`bumpFragment`,i=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;t.IncludesShadersStoreWGSL[r]||(t.IncludesShadersStoreWGSL[r]=i);var a={name:r,shader:i},o=`samplerFragmentDeclaration`,s=`#ifdef _DEFINENAME_
...
#endif
`;t.IncludesShadersStoreWGSL[o]||(t.IncludesShadersStoreWGSL[o]=s);var ee=e({bumpFragmentFunctionsWGSL:()=>u}),c=`bumpFragmentFunctions`,l=`#if defined(BUMP)
...
#endif
`;t.IncludesShadersStoreWGSL[c]||(t.IncludesShadersStoreWGSL[c]=l);var u={name:c,shader:l},d=e({bumpFragmentMainFunctionsWGSL:()=>m}),f=`bumpFragmentMainFunctions`,p=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
#if defined(TANGENT) && defined(NORMAL) 
...
#endif
`;t.IncludesShadersStoreWGSL[f]||(t.IncludesShadersStoreWGSL[f]=p);var m={name:f,shader:p},te=e({fogFragmentDeclarationWGSL:()=>_}),h=`fogFragmentDeclaration`,g=`#ifdef FOG
...
#endif
`;t.IncludesShadersStoreWGSL[h]||(t.IncludesShadersStoreWGSL[h]=g);var _={name:h,shader:g},v=e({imageProcessingDeclarationWGSL:()=>x}),y=`imageProcessingDeclaration`,b=`#ifdef EXPOSURE
...
#endif
`;t.IncludesShadersStoreWGSL[y]||(t.IncludesShadersStoreWGSL[y]=b);var x={name:y,shader:b},S=e({imageProcessingFunctionsWGSL:()=>T}),C=`imageProcessingFunctions`,w=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;t.IncludesShadersStoreWGSL[C]||(t.IncludesShadersStoreWGSL[C]=w);var T={name:C,shader:w},E=e({lightFragmentWGSL:()=>k}),D=`lightFragment`,O=`#ifdef LIGHT{X}
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[D]||(t.IncludesShadersStoreWGSL[D]=O);var k={name:D,shader:O},A=e({lightUboDeclarationWGSL:()=>N}),j=`lightUboDeclaration`,M=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[j]||(t.IncludesShadersStoreWGSL[j]=M);var N={name:j,shader:M},P=`ltcHelperFunctions`,F=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;t.IncludesShadersStoreWGSL[P]||(t.IncludesShadersStoreWGSL[P]=F);var I=`clusteredLightingFunctions`,ne=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;t.IncludesShadersStoreWGSL[I]||(t.IncludesShadersStoreWGSL[I]=ne);var re=e({reflectionFunctionWGSL:()=>z}),L=`reflectionFunction`,R=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;t.IncludesShadersStoreWGSL[L]||(t.IncludesShadersStoreWGSL[L]=R);var z={name:L,shader:R},B=e({shadowsFragmentFunctionsWGSL:()=>U}),V=`shadowsFragmentFunctions`,H=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;t.IncludesShadersStoreWGSL[V]||(t.IncludesShadersStoreWGSL[V]=H);var U={name:V,shader:H},W=`logDepthFragment`,G=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;t.IncludesShadersStoreWGSL[W]||(t.IncludesShadersStoreWGSL[W]=G);var K=`fogFragment`,q=`#ifdef FOG
...
#endif
`;t.IncludesShadersStoreWGSL[K]||(t.IncludesShadersStoreWGSL[K]=q);var J=`prePassDeclaration`,Y=`#ifdef PREPASS
...
#endif
#endif
`;t.IncludesShadersStoreWGSL[J]||(t.IncludesShadersStoreWGSL[J]=Y);var X=`oitDeclaration`,ie=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;t.IncludesShadersStoreWGSL[X]||(t.IncludesShadersStoreWGSL[X]=ie);var Z=`decalFragment`,ae=`#ifdef DECAL
...
#endif
`;t.IncludesShadersStoreWGSL[Z]||(t.IncludesShadersStoreWGSL[Z]=ae);var Q=`depthPrePass`,oe=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;t.IncludesShadersStoreWGSL[Q]||(t.IncludesShadersStoreWGSL[Q]=oe);var $=`oitFragment`,se=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;t.IncludesShadersStoreWGSL[$]||(t.IncludesShadersStoreWGSL[$]=se);export{u as _,N as a,n as b,E as c,x as d,v as f,d as g,m as h,re as i,T as l,te as m,B as n,A as o,_ as p,z as r,k as s,U as t,S as u,ee as v,a as y};