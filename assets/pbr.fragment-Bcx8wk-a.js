import{n as ee}from"./index-De0cjcb3.js";import{t as e}from"./shaderStore-D-XQlhUT.js";import"./clipPlaneFragmentDeclaration-CkHV8ISd.js";import"./clipPlaneFragment-BiT8Oqeh.js";import"./oitFragment-BPsk8wfd.js";import"./helperFunctions-DDOSx8cz.js";import"./mainUVVaryingDeclaration-DYXWxNAK.js";import"./harmonicsFunctions-JnqeEQrg.js";var t=`importanceSampling`,te=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDggx(vec2 u,float a) {float phi=2.*PI*u.x;float cosTheta2=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
vec3 hemisphereImportanceSampleDCharlie(vec2 u,float a) { 
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=te);var n=`hdrFilteringFunctions`,r=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var o=`pbrFragmentExtraDeclaration`,ne=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=ne);var s=`samplerFragmentAlternateDeclaration`,re=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=re);var c=`pbrFragmentSamplersDeclaration`,l=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=l);var u=`subSurfaceScatteringFunctions`,d=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=d);var f=`pbrHelperFunctions`,ie=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=ie);var p=`pbrDirectLightingSetupFunctions`,ae=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=ae);var m=`pbrDirectLightingFalloffFunctions`,oe=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=oe);var h=`pbrDirectLightingFunctions`,g=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _=`pbrIBLFunctions`,v=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var y=`pbrBlockAlbedoOpacity`,b=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var x=`pbrBlockReflectivity`,se=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=se);var S=`pbrBlockAmbientOcclusion`,ce=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ce);var C=`pbrBlockAlphaFresnel`,le=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=le);var w=`pbrBlockAnisotropic`,ue=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=ue);var T=`pbrBlockReflection`,de=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=de);var E=`pbrBlockSheen`,fe=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=fe);var D=`pbrBlockClearcoat`,pe=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=pe);var O=`pbrBlockIridescence`,k=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=k);var A=`pbrBlockSubSurface`,j=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);var M=`pbrBlockReflectance0`,N=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=N);var P=`pbrClusteredLightingFunctions`,F=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=F);var I=`pbrBlockNormalGeometric`,L=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var R=`pbrBlockNormalFinal`,z=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var B=`pbrBlockLightmapInit`,me=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=me);var V=`pbrBlockGeometryInfo`,he=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=he);var H=`pbrBlockReflectance`,ge=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=ge);var U=`pbrBlockDirectLighting`,_e=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=_e);var W=`pbrBlockFinalLitComponents`,ve=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=ve);var G=`pbrBlockFinalUnlitComponents`,ye=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=ye);var K=`pbrBlockFinalColorComposition`,q=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=q);var J=`pbrBlockImageProcessing`,be=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=be);var Y=`pbrBlockPrePass`,xe=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=xe);var X=`pbrDebug`,Se=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Se);var Ce=ee({pbrPixelShader:()=>$}),Z=`pbrPixelShader`,Q=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[Z]||(e.ShadersStore[Z]=Q);var $={name:Z,shader:Q};export{Ce as n,$ as t};