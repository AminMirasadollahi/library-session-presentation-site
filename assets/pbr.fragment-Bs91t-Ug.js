import{n as ee}from"./index-CI74_Llx.js";import{t as e}from"./shaderStore-D-XQlhUT.js";import"./oitFragment-DM-Z57TF.js";import"./clipPlaneFragmentDeclaration-CkD3FoH_.js";import"./helperFunctions-B8_eSGDF.js";import"./mainUVVaryingDeclaration-D16F0_l1.js";import"./harmonicsFunctions-BLvTHzWT.js";var t=`importanceSampling`,te=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDggx(u: vec2f,a: f32)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=(1.-u.y)/(1.+(a+1.)*((a-1.)*u.y));var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
fn hemisphereImportanceSampleDCharlie(u: vec2f,a: f32)->vec3f { 
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=te);var n=`hdrFilteringFunctions`,r=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=r);var i=`pbrFragmentExtraDeclaration`,a=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=a);var o=`samplerFragmentAlternateDeclaration`,ne=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=ne);var s=`pbrFragmentSamplersDeclaration`,re=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=re);var c=`subSurfaceScatteringFunctions`,l=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=l);var u=`pbrHelperFunctions`,d=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=d);var f=`pbrDirectLightingSetupFunctions`,ie=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=ie);var p=`pbrDirectLightingFalloffFunctions`,ae=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=ae);var m=`pbrBlockReflectance0`,h=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=h);var g=`pbrDirectLightingFunctions`,_=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=x);var S=`pbrBlockReflectivity`,oe=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=oe);var C=`pbrBlockAmbientOcclusion`,se=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=se);var w=`pbrBlockAlphaFresnel`,ce=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=ce);var T=`pbrBlockAnisotropic`,le=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=le);var E=`pbrBlockReflection`,ue=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=ue);var D=`pbrBlockSheen`,de=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=de);var O=`pbrBlockClearcoat`,k=`struct clearcoatOutParams
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var H=`pbrBlockReflectance`,fe=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=fe);var U=`pbrBlockDirectLighting`,pe=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=pe);var W=`pbrBlockFinalLitComponents`,me=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=me);var G=`pbrBlockFinalUnlitComponents`,he=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=he);var K=`pbrBlockFinalColorComposition`,ge=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=ge);var q=`pbrBlockImageProcessing`,_e=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[q]||(e.IncludesShadersStoreWGSL[q]=_e);var J=`pbrBlockPrePass`,Y=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var X=`pbrDebug`,ve=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=ve);var ye=ee({pbrPixelShaderWGSL:()=>$}),Z=`pbrPixelShader`,Q=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[Z]||(e.ShadersStoreWGSL[Z]=Q);var $={name:Z,shader:Q};export{ye as n,$ as t};