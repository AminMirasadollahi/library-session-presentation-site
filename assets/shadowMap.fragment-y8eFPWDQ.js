import{n as e}from"./index-B7cg6daD.js";import{t}from"./shaderStore-D-XQlhUT.js";import"./clipPlaneFragmentDeclaration-ClMTyW6b.js";import"./packingFunctions-BhIxEOQ7.js";var n=e({shadowMapFragmentWGSL:()=>a}),r=`shadowMapFragment`,i=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
...
#endif
`;t.IncludesShadersStoreWGSL[r]||(t.IncludesShadersStoreWGSL[r]=i);var a={name:r,shader:i},o=`bayerDitherFunctions`,s=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;t.IncludesShadersStoreWGSL[o]||(t.IncludesShadersStoreWGSL[o]=s);var c=`shadowMapFragmentExtraDeclaration`,l=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;t.IncludesShadersStoreWGSL[c]||(t.IncludesShadersStoreWGSL[c]=l);var u=e({shadowMapPixelShaderWGSL:()=>p}),d=`shadowMapPixelShader`,f=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;t.ShadersStoreWGSL[d]||(t.ShadersStoreWGSL[d]=f);var p={name:d,shader:f};export{n as i,u as n,a as r,p as t};